<template>
  <div class="SectionVilla">
    <article class="containerFirst">
      <div class="image"><img src="../assets/images/top/img_Villa001.jpg" alt=""/></div>
      <div class="txtColFirst">
    ...
    <article class="container">
      <div class="image"><img src="../assets/images/top/img_Villa002.jpg" alt=""/></div>
      <div class="txtCol">
        <header>
    ...
    <article class="container">
      <div class="image"><img src="../assets/images/top/img_Villa003.jpg" alt=""/></div>
      <div class="txtCol">
        <header>
    ...
    <article class="container">
      <div class="image"><img src="../assets/images/top/img_Villa004.jpg" alt=""/></div>
      <div class="txtCol">
