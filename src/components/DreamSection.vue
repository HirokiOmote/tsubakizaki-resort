<template>
  <article class="Section">
    <h2 class="Header"><img src="../assets/images/top/ttl_DreamMain.svg" alt="セカンドライフ"/></h2>
    <article class="First">
      <div class="container">
        <div class="Image">
      ...
      <a class="Btn" href="">出店についてのお問い合わせはこちら</a>
    </article>
    ...
    <a href="#" class="Btn">そのほか全てのお問い合わせはこちら</a>
  </article>
</template>
...
.Header {
  ...
  text-align: center;
  background: $bgColor url("../assets/images/top/bg_Dream.png") 60% 41% no-repeat;
  background-size: 159%;
  @include media( sm ) {
    padding: 192px 0 232px;
...
.containerMap {
  ...
  h3 {
    ...
    &::before {
      ...
      height: 28px;
      margin-right: 10px;
      background: url("../assets/images/top/img_Mappin.png") no-repeat;
